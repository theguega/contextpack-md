...
from contextpack.scraper import extract_content, fetch_and_scrape
...
def test_extract_content():
    ...
    with patch("trafilatura.extract") as mock_extract:
        ...
        mock_extract.assert_called_once_with(
            html, url=url, output_format="markdown", include_links=True, include_images=False
        )
...
def test_fetch_and_scrape_success():
    ...
    with patch("trafilatura.fetch_url") as mock_fetch:
        with patch("contextpack.scraper.extract_content") as mock_extract:
