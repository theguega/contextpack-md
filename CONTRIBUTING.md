...
This project uses [Pixi](https://pixi.sh) and [uv](https://github.com/astral-sh/uv) for dependency management.

```bash
# Clone the repository
git clone https://github.com/your-username/contextpack.git
cd contextpack
